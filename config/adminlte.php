...
return [
    ...
    */
    ...
    'classes_auth_footer' => '',
    'classes_auth_icon' => '',
    'classes_auth_btn' => 'bg-gradient-primary',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here we can modify the url categories of the admin panel.
    |
        ...
        'YearPicker' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '/vendor/year-picker/yearpicker.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '/vendor/year-picker/yearpicker.js',
                ],
            ],
        ],
        ...
        'MonthPicker' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '/vendor/month-picker/MonthPicker.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '/vendor/month-picker/MonthPicker.js',
                ],
            ],
        ],
        ...
        'summernote' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//adminlte.io/themes/v3/plugins/summernote/summernote-bs4.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//adminlte.io/themes/v3/plugins/summernote/summernote-bs4.min.css',
                ],
            ],
        ],
        'bsCustomFileInput' => [
